...
async function processCollectionDetails(collectionId) {
  return cacheWrapCollectionDetails(collectionId, async () => {
    ...
    return {
      ...
      imdbRating: averageImdbRating.toFixed(1),
      ...
      rating:
        ...
        }, 0) / releasedParts.reduce((sum, movie) => sum + (movie.vote_count || 0), 0) || 0,
      director: lastMovieMeta.director || [],
      cast: lastMovieMeta.cast?.slice(0, 10) || [],
      genres: lastMovieMeta.genres || [],
      links: lastMovieMeta.links || [],
      trailers: lastMovieMeta.trailers || [],
