...
async function initMovieDb() {
  ...
  initializationPromise = (async () => {
    ...
    moviedb = new MovieDb(process.env.TMDB_API_KEY, "https://api.themoviedb.org/3/", 40); //requestsPerSecondLimit = 45, as default = 50 sometimes results in 429 (official limit is around 50)
    return moviedb;
  })();
