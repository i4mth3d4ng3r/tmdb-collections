  ...
  return cacheWrapMovieDetails(imdbId, async () => {
    try {
      ...
      const response = await ky.get(`https://v3-cinemeta.strem.io/meta/${type}/${imdbId}.json`, {
        //this endpoint is missing imdbRating form some movies, while old(?) cinemeta-live.strem.io not. Github issue was resolved as "not planned" (wtf)
      ...
      // console.log("imdbRating", data.meta.imdbRating);
